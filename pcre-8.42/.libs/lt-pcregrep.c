...
/* ./.libs/lt-pcregrep.c - temporary wrapper executable for .libs/pcregrep.exe
   Generated by libtool (GNU libtool) 2.4.6.40-6ca5-dirty

   The pcregrep program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "pcregrep.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# pcregrep - temporary wrapper script for .libs/pcregrep.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6.40-6ca5-dirty\n", f);
  fputs ("#\n", f);
  fputs ("# The pcregrep program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' libpcre.la libpcreposix.la /c/codes/pcre-8.42/libpcre.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"pcregrep.exe:pcregrep:$LINENO: libtool wrapper (GNU libtool) 2.4.6.40", f);
  fputs ("-6ca5-dirty\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"pcregrep.exe:pcregrep:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"pcregrep.exe:pcregrep:$LINENO: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
