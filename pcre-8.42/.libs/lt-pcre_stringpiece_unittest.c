...
/* ./.libs/lt-pcre_stringpiece_unittest.c - temporary wrapper executable for .libs/pcre_stringpiece_unittest.exe
   Generated by libtool (GNU libtool) 2.4.6.40-6ca5-dirty

   The pcre_stringpiece_unittest program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "c:\\codes\\pcre-8.42\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "c:\\codes\\pcre-8.42\\.libs;C:\\MinGW\\msys\\1.0\\local\\lib;C:\\MinGW\\msys\\1.0\\local\\bin;";
const char * TARGET_PROGRAM_NAME = "pcre_stringpiece_unittest.exe"; /* hopefully, no .exe */
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4.6.40-6ca5-dirty\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# pcre_stringpiece_unittest - temporary wrapper script for .libs/pcre_stringpie", f);
  fputs ("ce_unittest.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6.40-6ca5-dirty\n", f);
  fputs ("#\n", f);
  fputs ("# The pcre_stringpiece_unittest program cannot be directly executed until all t", f);
  fputs ("he libtool\n", f);
  ...
  fputs ("  generated_by_libtool_version='2.4.6.40-6ca5-dirty'\n", f);
  fputs ("  notinst_deplibs=' libpcrecpp.la /c/codes/pcre-8.42/libpcre.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"pcre_stringpiece_unittest.exe:pcre_stringpiece_unittest:$LINENO: libt", f);
  fputs ("ool wrapper (GNU libtool) 2.4.6.40-6ca5-dirty\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"pcre_stringpiece_unittest.exe:pcre_stringpiece_unittest:$LINENO: new", f);
  fputs ("argv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"pcre_stringpiece_unittest.exe:pcre_stringpiece_unittest:$LINENO:", f);
  fputs (" newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='pcre_stringpiece_unittest.exe'\n", f);
  ...
  fputs ("    PATH=/c/codes/pcre-8.42/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/c/codes/pcre-8.42/.libs:$PATH\"\n", f);
  fputs ("\n", f);
