...
/* ./.libs/lt-pcre_scanner_unittest.c - temporary wrapper executable for .libs/pcre_scanner_unittest.exe
   Generated by libtool (GNU libtool) 2.4.6.40-6ca5-dirty

   The pcre_scanner_unittest program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "pcre_scanner_unittest.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# pcre_scanner_unittest - temporary wrapper script for .libs/pcre_scanner_unitt", f);
  fputs ("est.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6.40-6ca5-dirty\n", f);
  fputs ("#\n", f);
  fputs ("# The pcre_scanner_unittest program cannot be directly executed until all the l", f);
  fputs ("ibtool\n", f);
  ...
  fputs ("    echo \"pcre_scanner_unittest.exe:pcre_scanner_unittest:$LINENO: libtool wrap", f);
  fputs ("per (GNU libtool) 2.4.6.40-6ca5-dirty\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"pcre_scanner_unittest.exe:pcre_scanner_unittest:$LINENO: newargv[$lt", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"pcre_scanner_unittest.exe:pcre_scanner_unittest:$LINENO: newargv", f);
  ...
  fputs ("\n", f);
  fputs ("  program='pcre_scanner_unittest.exe'\n", f);
