...
/* ./.libs/lt-pcretest.c - temporary wrapper executable for .libs/pcretest.exe
...
const char * TARGET_PROGRAM_NAME = "pcretest.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# pcretest - temporary wrapper script for .libs/pcretest.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6.40-6ca5-dirty\n", f);
  fputs ("#\n", f);
  fputs ("# The pcretest program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"pcretest.exe:pcretest:$LINENO: libtool wrapper (GNU libtool) 2.4.6.40", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"pcretest.exe:pcretest:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"pcretest.exe:pcretest:$LINENO: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
