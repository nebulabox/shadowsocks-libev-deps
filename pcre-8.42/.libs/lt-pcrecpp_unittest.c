...
/* ./.libs/lt-pcrecpp_unittest.c - temporary wrapper executable for .libs/pcrecpp_unittest.exe
   Generated by libtool (GNU libtool) 2.4.6.40-6ca5-dirty

   The pcrecpp_unittest program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "pcrecpp_unittest.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# pcrecpp_unittest - temporary wrapper script for .libs/pcrecpp_unittest.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6.40-6ca5-dirty\n", f);
  fputs ("#\n", f);
  fputs ("# The pcrecpp_unittest program cannot be directly executed until all the libtoo", f);
  fputs ("l\n", f);
  ...
  fputs ("    echo \"pcrecpp_unittest.exe:pcrecpp_unittest:$LINENO: libtool wrapper (GNU l", f);
  fputs ("ibtool) 2.4.6.40-6ca5-dirty\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"pcrecpp_unittest.exe:pcrecpp_unittest:$LINENO: newargv[$lt_dump_args", f);
  fputs ("_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"pcrecpp_unittest.exe:pcrecpp_unittest:$LINENO: newargv[0]: $prog", f);
  ...
  fputs ("\n", f);
  fputs ("  program='pcrecpp_unittest.exe'\n", f);
